...
function adicionarElemento() {
  const nome = document.getElementById("txtnovoNome").value;//pega nome atribuido
  const cpf = document.getElementById("txtnovoCpf").value;//pega cpf atribuido
  const data = obterDataAtual(); //data 
  const hora = obterHoraAtual(); // hora

  if (cpf === "" || nome === "") { // se algum campo estiver vazio 
    alert("Preencha todos os campos!");//exibe alerta
  } else {
